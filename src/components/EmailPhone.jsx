...
class EmailPhone extends Component {
    ...
    onFinish = (values) => {
        ...
        this.setState({
            loading: true 
          }, this.postHome(this.props.postData));
